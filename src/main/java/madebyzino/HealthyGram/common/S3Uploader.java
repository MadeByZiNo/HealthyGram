package madebyzino.HealthyGram.common;
...
public class S3Uploader {
    ...
    public String upload(MultipartFile multipartFile, String dirName)  {
        ...
        try {
            ...
            throw new CustomException(ErrorCode.S3_UPLOADER_ERROR, "upload error : " + e.getMessage());
        }
    ...
    private File convert(MultipartFile file) throws IOException {
        ...
        if (convertFile.createNewFile()) {
            try (FileOutputStream fos = new FileOutputStream(convertFile)) {
                ...
                throw new CustomException(ErrorCode.S3_UPLOADER_ERROR, "convert error : " + e.getMessage());
            }
            return convertFile;
        }
        throw new CustomException(ErrorCode.S3_UPLOADER_ERROR, String.format("convert error. %s", originalFileName));
    }
